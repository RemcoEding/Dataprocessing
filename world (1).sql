...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 25 mrt 2022 om 11:24
...
('ABW', 'Aruba', 'North America', 'Caribbean', 193.00, 2001, 103000, 78.3, 828.00, 793.00, 'Aruba', 'Nonmetropolitan Territory of The Netherlands', 'Beatrix', 129, 'AW'),
...
('Tes', 'test', '', 'test', 3.00, 3, 3, 3.0, 3.00, 3.00, 'tetst', 'test', 'test', 3, 'te'),
...
INSERT INTO `countrylanguage` (`ID`, `CountryCode`, `Language`, `IsOfficial`, `Percentage`) VALUES
(1, 'ABW', 'Dutch', 'T', 5.6),
(2, 'ABW', 'English', 'F', 9.5),
...
(109, 'BOL', 'Aimará', 'T', 3.2),
(110, 'BOL', 'Guaraní', 'F', 0.1),
(111, 'BOL', 'Ketšua', 'T', 8.1),
...
(353, 'GTM', 'Kekchí', 'F', 4.9),
(354, 'GTM', 'Mam', 'F', 2.7),
(355, 'GTM', 'Quiché', 'F', 10.1),
...
(695, 'PAN', 'Guaymí', 'F', 5.3),
(696, 'PAN', 'Spanish', 'T', 76.8),
(697, 'PCN', 'Pitcairnese', 'F', 0.0),
(698, 'PER', 'Aimará', 'T', 2.3),
(699, 'PER', 'Ketšua', 'T', 16.4),
...
ALTER TABLE `city`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `City_CountryCode` (`CountryCode`) USING BTREE;
...
ALTER TABLE `countrylanguage`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `CountryLanguage_CountryCode` (`CountryCode`) USING BTREE;
...
--
-- AUTO_INCREMENT voor een tabel `countrylanguage`
--
ALTER TABLE `countrylanguage`
